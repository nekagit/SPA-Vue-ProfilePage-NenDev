...
<template>
  <div class="container flex flex-row items-start justify-start">
    <div class="p-4 bg-slate-300 mt-5">
    ...
    <div class="w-full md:w-[50%] lg:w-[64%] ">
      <h1 class="font-bold text-xl ">{{ sectionItem.title }}</h1>
